...
* Faster generation: reflection lookups are cached per class, and classes that passed the unsupported and self-referential type check are not checked again.
